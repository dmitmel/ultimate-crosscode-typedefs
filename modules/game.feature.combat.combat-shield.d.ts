    ...
    namespace sc{
        ...
        namespace COMBAT_SHIELDS{ 
            ...
            interface DIRECTIONAL extends sc.CombatShield {
                isActive(this: this, combatant: ig.ENTITY.Combatant, hitForce: sc.CircleHitForce | sc.DirectHitForce): boolean
            }
            ...
            interface PLAYER extends sc.COMBAT_SHIELDS.DIRECTIONAL {
                ...
                isActive(this: this, playerEntity: sc.PlayerBaseEntity, hitForce: sc.CombatForce & {getHitDir(entity: ig.Entity, vec: Vec2): Vec2}, attackInfo: sc.AttackInfo, f: unknown, isPerfect: boolean): boolean
            }
